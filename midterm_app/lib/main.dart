...
import 'pages/list_patient_page.dart';
import 'pages/list_user_page.dart';

import 'pages/result_page.dart';
import 'pages/sign_up_page.dart';
import 'pages/team_pic_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: <String, WidgetBuilder>{
        ...
        '/4': (context) => SignUpScreen(),
        '/5': (context) => ResetPasswordScreen(),
        '/6': (context) => ListPatientPage(),
        '/7': (context) => Result_Page(),
        '/8': (context) => TeamPicPage(),
      },
    );
  }
}
